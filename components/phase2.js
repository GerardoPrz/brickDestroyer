...
export class Phase2 extends Phase{
    ...
    create(){
        /* No siempre podremos colocar los ladrillos mediante una configuración
         del método staticGroup(). Hay veces que la colocación no 
         responde a un patrón fácilmente programable, por lo que 
         los ladrillos también los podemos colocar uno a uno. */
